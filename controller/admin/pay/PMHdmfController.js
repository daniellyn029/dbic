app.controller('PMHdmfController', ['$scope', '$rootScope', '$location', '$routeParams', '$http', '$cookieStore', '$timeout', 'spinnerService', '$filter', 'Upload', 'DTOptionsBuilder', 'DTColumnBuilder', '$q', '$compile', 'textAngularManager',
    function ($scope, $rootScope, $location, $routeParams, $http, $cookieStore, $timeout, spinnerService, $filter, Upload, DTOptionsBuilder, DTColumnBuilder, $q, $compile, textAngularManager) {
        ...
        $scope.pagibigtable = function () {
            ...
            vm.dtColumns = [
                DTColumnBuilder.newColumn('maximum').withTitle('Maximum').withClass('btnTD').notSortable(),
                DTColumnBuilder.newColumn('emp').withTitle('Employee Contribution').withClass('btnTD').notSortable(),
                DTColumnBuilder.newColumn('pay_date').withTitle('Employer Contribution').withClass('btnTD').notSortable(),
