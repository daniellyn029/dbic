    ...
    function ($scope, $compile, $rootScope, $location, $routeParams, $http, $cookieStore, $timeout, spinnerService, $filter, Upload, DTOptionsBuilder, DTColumnBuilder, $q, $compile, textAngularManager) {
        ...
        $scope.timekeepings = function (date) {
            ...
            $scope.calendarOptionstimekeeping = {
                ...
                eventRender: function(event, element) {
                        //Display html in full calendar
                       element.find(".fc-title").prepend(event.backgroundColor_pending);
                       element.find(".fc-title").prepend(event.backgroundColor_declined);
                       element.find(".fc-title").prepend(event.backgroundColor_approved);
        ...
        $scope.addobtrip = function () {
            ...
            if (r == true) {
                ...
                $http.post(apiUrl + 'admin/tk/app/ob/create.php', urlData)
                    .then(function (response, status) {
                        var data = response.data;
