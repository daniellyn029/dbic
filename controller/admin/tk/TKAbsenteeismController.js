app.controller('TKAbsenteeismController',[ '$scope', '$rootScope', '$location', '$routeParams', '$http', '$cookieStore', '$timeout', 'spinnerService', '$filter', 'Upload', 'DTOptionsBuilder', 'DTColumnBuilder', '$q', '$compile','textAngularManager',
function($scope, $rootScope, $location, $routeParams, $http, $cookieStore, $timeout, spinnerService, $filter, Upload, DTOptionsBuilder, DTColumnBuilder, $q, $compile, textAngularManager ){
	...
	//Table Funtion
	$scope.absenteeism_func = function (){
		var urlData = {
			'accountid'	: $scope.dashboard.values.accountid,
		}

		$http.post(apiUrl+'admin/tk/report/absenteeism/view.php',urlData)
		.then( function (response, status){		
			...
			if(data.status=="error"){
				$rootScope.modalDanger();
				$scope.absenteeism_view = [];

			}else{
				$scope.absenteeism_view = data;
			}
	...
	$scope.search= function(){
		...
		$http.post(apiUrl+"admin/tk/report/absenteeism/search.php", urlData)
		.then( function (response, status){     
			var data = response.data;
	...
	$scope.export = function () {
		...
		var url = apiUrl+"admin/tk/report/absenteeism/export.php?idsuperior=" + idsuperior + "&emp=" + emp + "&department=" + department + "&company=" + company + "&datenow=" + datenow;	
