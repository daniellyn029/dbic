app.controller('TKSetupOvertimeRatesController', ['$scope', '$rootScope', '$location', '$routeParams', '$http', '$cookieStore', '$timeout', 'spinnerService', '$filter', 'Upload', 'DTOptionsBuilder', 'DTColumnBuilder', '$q', '$compile', 'textAngularManager',
    function ($scope, $rootScope, $location, $routeParams, $http, $cookieStore, $timeout, spinnerService, $filter, Upload, DTOptionsBuilder, DTColumnBuilder, $q, $compile, textAngularManager) {
        ...
        $scope.overtimerates = function () {
            ...
            vm.dtOptions = DTOptionsBuilder.newOptions()
                .withOption('ajax', {
                    url: apiUrl + 'admin/tk/setup/overtimerates/data.php',
                    type: 'POST',
                    data: function (d) {
            ...
            vm.dtColumns = [
                DTColumnBuilder.newColumn('id').withTitle('No.').withClass('btnTD').notSortable(),
                DTColumnBuilder.newColumn('alias').withTitle('ID').withClass('btnTD').notSortable(),
            ...
            $scope.edit_view = function (id) {
                ...
                $http.post(apiUrl + 'admin/tk/setup/overtimerates/edit_view.php', urlData)
                    .then(function (response, status) {
                        var data = response.data;
                        $scope.edit = data;
                    }, function (response) {
            ...
            $scope.editovertimerates = function () {
                $scope.isSaving = true;
                ...
                $http.post(apiUrl + 'admin/tk/setup/overtimerates/edit.php', urlData)
                    .then(function (response, status) {
                        ...
                        if (data.status == "error") {
                            ...
                            $rootScope.dymodalmsg = "Overtime Rates updated successfully";
