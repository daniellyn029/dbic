app.controller('HRWageIncreaseController',[ '$scope', '$rootScope', '$location', '$routeParams', '$http', '$cookieStore', '$timeout', 'spinnerService', '$filter', 'Upload', 'DTOptionsBuilder', 'DTColumnBuilder', '$q', '$compile','textAngularManager',
function($scope, $rootScope, $location, $routeParams, $http, $cookieStore, $timeout, spinnerService, $filter, Upload, DTOptionsBuilder, DTColumnBuilder, $q, $compile, textAngularManager ){

	//$cookieStore.remove('emailurl');
	
	$scope.headerTemplate="view/admin/header/index.html";
	$scope.leftNavigationTemplate="view/admin/hr/personnelaction/wageincrease/sidebar.html";
	...
	$scope.files2 = function(id){
		var file = id;
		window.location = '/dbic/assets/php/admin/hr/personnelaction/wageincrease/pix/download.php?file='+file;
	}
	...
	$scope.currentTable = function(){
		...
		vm.dtOptions = DTOptionsBuilder.newOptions()
			.withOption('ajax', {
				url: apiUrl+'admin/hr/personnelaction/wageincrease/data.php',
				type: 'POST',
				data: function(d){
		...
		vm.dtColumns = [
			DTColumnBuilder.newColumn('refferenceno').withTitle('Document ID').notSortable().withClass('btnTD'), //Jerald 13072020
            ...
            .renderWith(function(data, type, full, meta){
                    return '<button id="' + data.id + '" class="btn btn-flat btn-sm btn-success" data-target="#WageIncreaseView" data-toggle="modal" onclick="angular.element(this).scope().getDataByIdCurrent(\'' +data.id+ '\')"><i class="fa fa-pencil-square-o fa-xs"></i> View</button>';
            }),
		];
		vm.dtInstance = {};
		...
		$scope.getDataByIdCurrent = function(id){
			...
			$http.post("/dbic/assets/php/admin/hr/personnelaction/wageincrease/getDataByIdCurrent.php", urlData)
			.then(function(result){
				if(result.data.status == "empty"){
					...
					$scope.picFile = 'assets/php/admin/hr/personnelaction/wageincrease/pix/'+$scope.viewCurrent.picFile;
	...
	$scope.archiveTable = function(){
		...
		vm.dtOptions = DTOptionsBuilder.newOptions()
			.withOption('ajax', {
				url: apiUrl+'admin/hr/personnelaction/wageincrease/dataArchive.php',
				type: 'POST',
				data: function(d){
					d.accountid 	= $scope.dashboard.values.accountid,
		...
		vm.dtColumns = [
			...
			DTColumnBuilder.newColumn(null).withTitle('Action').notSortable().withClass('btnTD')
            .renderWith(function(data, type, full, meta){
                    return '<button class="btn btn-flat btn-sm btn-success" data-target="#WageIncreaseViewArchive" data-toggle="modal" onclick="angular.element(this).scope().getDataByIdArchive(\'' +data.id+ '\')"><i class="fa fa-pencil-square-o fa-xs"></i> View</button>';
            }),
		];
		...
		$scope.resetSearchArchive = function(){
			$scope.searchArchive			= [];
			$scope.searchArchive.datecreate= ''; 
			$scope.searchArchive.effectdate= '';
			$scope.searchArchive.acct		= ''; 
			$timeout(function () {	
		...
		$scope.getDataByIdArchive = function(id){
			...
			$http.post("/dbic/assets/php/admin/hr/personnelaction/wageincrease/getDataByIdArchive.php", urlData)
			.then(function(result){
				if(result.data.status == "empty"){
					$scope.viewArchive = [];
				}else{
					$scope.viewArchive = result.data[0];
					$scope.picFileArchive = 'assets/php/admin/hr/personnelaction/wageincrease/pix/'+$scope.viewArchive.picFile;
	...
	$scope.approversetupTable = function(){
		...
		vm.dtOptions = DTOptionsBuilder.newOptions()
			.withOption('ajax', {
				url: apiUrl+'admin/hr/personnelaction/wageincrease/dataApproverSetup.php',
				type: 'POST',
				data: function(d){
					d.accountid = $scope.dashboard.values.accountid
				}
		...
		$scope.allApproverTypeFunction = function(){
			...
			$http.post("/dbic/assets/php/admin/hr/personnelaction/wageincrease/allApproverType.php", urlData)
			.then(function(result){
				if(result.data.status == "empty"){
		...
		$scope.saveApproverSetup = function(){
			...
			if(($scope.sequence.approvertype1a==null||$scope.sequence.approvertype1a=="") && $scope.sequence.ctr_approvers >= 1 ){
			...
			if(($scope.sequence.approvertype1a==1&&$scope.sequence.approvertype1b==1) && $scope.sequence.ctr_approvers >= 1 ){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype1a!=1 && $scope.sequence.approver1a=="") && $scope.sequence.ctr_approvers >= 1){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if((($scope.sequence.approvertype1b==2||$scope.sequence.approvertype1b==3) && $scope.sequence.approver1b=="")  && $scope.sequence.ctr_approvers >= 1){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype2a==null||$scope.sequence.approvertype2a=="") && $scope.sequence.ctr_approvers >= 2){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype2a==1&&$scope.sequence.approvertype2b==1) && $scope.sequence.ctr_approvers >= 2){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype2a!=1 && $scope.sequence.approver2a=="") && $scope.sequence.ctr_approvers >= 2){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if((($scope.sequence.approvertype2b==2||$scope.sequence.approvertype2b==3) && $scope.sequence.approver2b=="") && $scope.sequence.ctr_approvers >= 2){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype3a==null||$scope.sequence.approvertype3a=="") && $scope.sequence.ctr_approvers >= 3){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype3a==1&&$scope.sequence.approvertype3b==1) && $scope.sequence.ctr_approvers >= 3){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype3a!=1 && $scope.sequence.approver3a=="") && $scope.sequence.ctr_approvers >= 3){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if((($scope.sequence.approvertype3b==2||$scope.sequence.approvertype3b==3) && $scope.sequence.approver3b=="") && $scope.sequence.ctr_approvers >= 3){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype4a==null||$scope.sequence.approvertype4a=="") && $scope.sequence.ctr_approvers >= 4){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype4a==1&&$scope.sequence.approvertype4b==1) && $scope.sequence.ctr_approvers >= 4){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype4a!=1 && $scope.sequence.approver4a=="") && $scope.sequence.ctr_approvers >= 4){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if((($scope.sequence.approvertype4b==2||$scope.sequence.approvertype4b==3) && $scope.sequence.approver4b=="") && $scope.sequence.ctr_approvers >= 4){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype5a==null||$scope.sequence.approvertype5a=="") && $scope.sequence.ctr_approvers >= 5){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype5a==1&&$scope.sequence.approvertype5b==1) && $scope.sequence.ctr_approvers >= 5){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype5a!=1 && $scope.sequence.approver5a=="") && $scope.sequence.ctr_approvers >= 5){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if((($scope.sequence.approvertype5b==2||$scope.sequence.approvertype5b==3) && $scope.sequence.approver5b=="") && $scope.sequence.ctr_approvers >= 5){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype6a==null||$scope.sequence.approvertype6a=="") && $scope.sequence.ctr_approvers >= 6){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype6a==1&&$scope.sequence.approvertype6b==1) && $scope.sequence.ctr_approvers >= 6){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype6a!=1 && $scope.sequence.approver6a=="") && $scope.sequence.ctr_approvers >= 6){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if((($scope.sequence.approvertype6b==2||$scope.sequence.approvertype6b==3) && $scope.sequence.approver6b=="") && $scope.sequence.ctr_approvers >= 6){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype7a==null||$scope.sequence.approvertype7a=="") && $scope.sequence.ctr_approvers >= 7){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype7a==1&&$scope.sequence.approvertype7b==1) && $scope.sequence.ctr_approvers >= 7){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if(($scope.sequence.approvertype7a!=1 && $scope.sequence.approver7a=="") && $scope.sequence.ctr_approvers >= 7){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
			...
			if((($scope.sequence.approvertype7b==2||$scope.sequence.approvertype7b==3) && $scope.sequence.approver7b=="") && $scope.sequence.ctr_approvers >= 7){
				$rootScope.dymodalstat = true;
				$rootScope.dymodaltitle= "Warning!";
            ...
            console.log(urlData);
            $http.post(apiUrl+'admin/hr/personnelaction/wageincrease/saveApproverSetup.php',urlData)
            .then( function (response, status){		
                var data = response.data;
        ...
        $scope.getApproverList = function(id){
            ...
            $http.post(apiUrl+'admin/hr/personnelaction/wageincrease/getApprovers.php',urlData)
            .then( function (response, status){
                $scope.isSaving = false;		
                var data = response.data;
	...
	$scope.autoFillEmpID = function(){
		...
		$http.post(apiUrl+'admin/hr/personnelaction/wageincrease/autoFillEmpID.php', urlData)
    ...
    $scope.showWageIncreaseEntryModal = function(){
		//alert( $('.entryfrm').length );
		$scope.entry = [];
		var urlData = {
			'accountid': $scope.dashboard.values.accountid
		}
		$http.post(apiUrl+'admin/hr/personnelaction/wageincrease/newentryview.php',urlData)
		.then( function (response, status){		
			var data = response.data;
			$scope.entry = data;
			$scope.entry.actiontaken	= "Wage Increase";
			$scope.entry.effectivedate = "";
			//if( $('.entryfrm').length == 1 ){ $('#LateralTransferEntry').appendTo("body").modal('show'); }
		}, function(response) {
			$rootScope.modalDanger();
		});
	}
	...
	$scope.autoFillEmpName = function(){
		...
		$http.post(apiUrl+'admin/hr/personnelaction/wageincrease/autoFillEmpName.php', urlData)
		.then(function(data, status){
	...
	$scope.updateEntryWageIncrease= function( file ){
		...
		$scope.isSaving = true;
		Upload.upload({
			url: apiUrl+'admin/hr/personnelaction/wageincrease/editEntry.php',
			method: 'POST',
			file: file,
			data: {
				'accountid'	: 	$scope.dashboard.values.accountid,
				...
				'targetPath': 	'../../../../admin/hr/personnelaction/wageincrease/pix/'						
			}
	...
	$scope.saveEntryWageIncrease= function( file ){
		...
		$scope.isSaving = true;
		Upload.upload({
			url: apiUrl+'admin/hr/personnelaction/wageincrease/saveEntry.php',
			method: 'POST',
			file: file,
			data: {
				'accountid'	: 	$scope.dashboard.values.accountid,
	...
	$scope.approve1 = function(){
		...
		if (r == true) {
			...
			$http.post("/dbic/assets/php/admin/hr/personnelaction/wageincrease/approve1.php", urlData)
			.then(function(result){
	...
	$scope.disapprove1 = function(){
		...
		if (r == true) {
			...
			$http.post("/dbic/assets/php/admin/hr/personnelaction/wageincrease/disapprove1.php", urlData)
			.then(function(result){
				var data = result.data;
				if( data.status == "error" ){
					$rootScope.modalDanger();
	...
	$scope.approve2 = function(){
		...
		if (r == true) {
			...
			$http.post("/dbic/assets/php/admin/hr/personnelaction/wageincrease/approve2.php", urlData)
			.then(function(result){
				var data = result.data;
				if( data.status == "error" ){
					$rootScope.modalDanger();
	...
	$scope.disapprove2 = function(){
		...
		if (r == true) {
			...
			$http.post("/dbic/assets/php/admin/hr/personnelaction/wageincrease/disapprove2.php", urlData)
			.then(function(result){
				var data = result.data;
				if( data.status == "error" ){
					$rootScope.modalDanger();
	...
	$scope.approve3 = function(){
		...
		if (r == true) {
			...
			$http.post("/dbic/assets/php/admin/hr/personnelaction/wageincrease/approve3.php", urlData)
			.then(function(result){
				var data = result.data;
				if( data.status == "error" ){
					$rootScope.modalDanger();
	...
	$scope.disapprove3 = function(){
		...
		if (r == true) {
			...
			$http.post("/dbic/assets/php/admin/hr/personnelaction/wageincrease/disapprove3.php", urlData)
			.then(function(result){
				var data = result.data;
				if( data.status == "error" ){
					$rootScope.modalDanger();
    ...
    $scope.entryModalTemplate="view/admin/hr/personnelaction/wageincrease/entry/index.html";
