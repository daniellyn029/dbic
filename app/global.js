app.run(function ($rootScope, $http , $cookieStore , $location, $routeParams, $window, $timeout) {
    /*
	$timeout(function () {
	...
	*/
	...
	$rootScope.editpassword = function(){
		...
		var urlData = {
			...
			'oldpassword'	 : $rootScope.password_old,
		...
		$http.post('/dbic/assets/php/editpassword.php',urlData)
	...
	$rootScope.getAllEmployeeReportFunc = function(){
		...
		$http.post("/dbic/assets/php/admin/hr/report/getAllEmployeeReport.php", urlData)
	...
	$rootScope.allEmployeePositionTitleFunc = function(){
		...
		$http.post("/dbic/assets/php/admin/hr/report/allEmployeePositionTitle.php", urlData)
		.then(function(result){
			if(result.data.status == "empty"){
	...
	$rootScope.allEmployeeDepartmentNameFunc = function(){
		...
		$http.post("/dbic/assets/php/admin/hr/report/allEmployeeDepartmentName.php", urlData)
		.then(function(result){
			if(result.data.status == "empty"){
	...
	$rootScope.allEmployeeDepartmentCodeFunc = function(){
		...
		$http.post("/dbic/assets/php/admin/hr/report/allEmployeeDepartmentCode.php", urlData)
		.then(function(result){
			if(result.data.status == "empty"){
	...
	$rootScope.allEmploymentStatusFunc = function(){
		...
		$http.post("/dbic/assets/php/admin/hr/employee/allEmploymentStatus.php", urlData)
		.then(function(result){
			if(result.data.status == "empty"){
    ...
    $rootScope.leavecounts = function () {
        ...
        $http.post("/dbic/assets/php/admin/mng/leave/leavecounts.php", urlData)
            .then(function (response, status) {
	 ...
	 $rootScope.timekeepingcounts = function () {
        ...
        $http.post("/dbic/assets/php/admin/mng/timekeeping/timekeepingcounts.php", urlData)
            .then(function (response, status) {
