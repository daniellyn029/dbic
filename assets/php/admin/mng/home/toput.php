...
if( !empty( $param->accountid ) && !empty($str) ){
	...
	$Qry2->fields    = "a.empID IN (".$str.") AND ((a.ut IS NOT NULL) AND a.ut <> '0.00') AND ( work_date >= '".$first_day_this_month."' AND work_date <= '".$last_day_this_month."' ) GROUP BY a.empID ORDER BY COUNT(a.empID) DESC LIMIT 5 ";
