...
$Qry->selected  = "*";
$Qry->fields    = "id != '".$param->accountid."' AND (idsuperior='".$param->accountid."' or idunit IN (".$ids.")) ORDER BY empname";
...
if(mysqli_num_rows($rs)>= 1){
    ...
    while($row=mysqli_fetch_array($rs)){
        ...
        $data[] = array( 
            ...
            // "getTotalWorkHours"   => sprintf('%0.2f', getTotalWorkHours($con, $date, $date1, $row['id'])) 
            // "getTotalWorkHours"   => getTotalWorkHours($con, $date, $date1, $row['id']) 
            "twh"       => '',
            "totalwh"   => '',
            "totalewh"  =>'',
            "totallate" =>'',
