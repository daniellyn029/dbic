...
$QryValidate->selected  = "a.*,b.id AS holiday_id, d.stime AS shiftin, d.ftime AS shiftout,d.breakin, d.breakout, d.stype, d.reghrs";
if( $ids== 0 ){
...
if(mysqli_num_rows($rsValidate)>= 1){
	while($rowValidate=mysqli_fetch_array($rsValidate)){
		...
		$shiftbrkin			= $rowValidate['breakin'];
		$shiftbrkout		= $rowValidate['breakout'];
