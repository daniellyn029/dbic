...
if($preference != ''){
    ...
    $approver2 = getApprovers($con, $param->acct, 'approver1', $param->acct);
    $approver3 = getApprovers($con, $param->acct, 'approver2', $param->acct);
    ...
    $approver3 = getApprovers($con, $param->acct, 'approver3', $param->acct);
    $approver4 = '';
}
