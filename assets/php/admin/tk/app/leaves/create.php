                            ...
                            foreach( $param['info']['leave_dates']  as $keys=>$value ){
                                ...
                                if( leaveExists($con, $date, $idacct, $idtimeleavetype) ){
                                    ...
                                    if( $hrs <= $leave_balance ){
                                        ...
                                        $Qry->selected 	= "creator, docnumber, idleave, idacct, idshift, idtimeleavetype, date, stime, ftime, hrs, date_create, id_payperiod, approver1";
                                        ...
                                        $Qry->fields 	= "'".$param['accountid']."', '".$docnumber."','".$idleave."', '".$idacct."', '".$idshift."', '".$idtimeleavetype."', '".$date."', '".$stime."', '".$ftime."', '".$hrs."', '".$date_create."', '".$id_period['id']."', '".$approver1."'";
                                        if( !empty( $remarks ) ){
