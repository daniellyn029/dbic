    ...
    if(mysqli_num_rows($rs)>=1){
        while($row=mysqli_fetch_array($rs)){
            ...
            if(!empty($row['createdbyid'])){
                if(file_exists("../../../../../../assets/images/Signatures/sign-".$row['createdbyid'].".png")){
                    $createdByPic = '<div class="img-container"><img src="assets/images/Signatures/sign-'.$row['createdbyid'].'.png" style="width: 70px;height: 40px;"></div>';
                }else{
                    $createdByPic = '<div class="img-container"><img src="assets/images/Signatures/default.png" style="width: 70px;height: 40px;"></div>';
                }
            }
            ...
            if(!empty($row['approver1'])){
                if(file_exists("../../../../../../assets/images/Signatures/sign-".$row['approver1'].".png")){
                    $approver1sign = '<div class="img-container"><img src="assets/images/Signatures/sign-'.$row['approver1'].'.png" style="width: 70px;height: 40px;"></div>';
                }else{
                    $approver1sign = '<div class="img-container"><img src="assets/images/Signatures/default.png" style="width: 70px;height: 40px;"></div>';
                }
            }
            ...
            if(!empty($row['approver2'])){
                if(file_exists("../../../../../../assets/images/Signatures/sign-".$row['approver2'].".png")){
                    $approver2sign = '<div class="img-container"><img src="assets/images/Signatures/sign-'.$row['approver2'].'.png" style="width: 70px;height: 40px;"></div>';
                }else{
                    $approver2sign = '<div class="img-container"><img src="assets/images/Signatures/default.png" style="width: 70px;height: 40px;"></div>';
                }
            }
            ...
            if(!empty($row['approver3'])){
                if(file_exists("../../../../../../assets/images/Signatures/sign-".$row['approver3'].".png")){
                    $approver3sign = '<div class="img-container"><img src="assets/images/Signatures/sign-'.$row['approver3'].'.png" style="width: 70px;height: 40px;"></div>';
                }else{
                    $approver3sign = '<div class="img-container"><img src="assets/images/Signatures/default.png" style="width: 70px;height: 40px;"></div>';
                }
            }
            ...
            if(!empty($row['approver4'])){
                if(file_exists("../../../../../../assets/images/Signatures/sign-".$row['approver4'].".png")){
                    $approver4sign = '<div class="img-container"><img src="assets/images/Signatures/sign-'.$row['approver4'].'.png" style="width: 70px;height: 40px;"></div>';
                }else{
                    $approver4sign = '<div class="img-container"><img src="assets/images/Signatures/default.png" style="width: 70px;height: 40px;"></div>';
                }
            }
            ...
            if(!empty($row['approver5'])){
                if(file_exists("../../../../../../assets/images/Signatures/sign-".$row['approver5'].".png")){
                    $approver5sign = '<div class="img-container"><img src="assets/images/Signatures/sign-'.$row['approver5'].'.png" style="width: 70px;height: 40px;"></div>';
                }else{
                    $approver5sign = '<div class="img-container"><img src="assets/images/Signatures/default.png" style="width: 70px;height: 40px;"></div>';
                }
            }
            ...
            if(!empty($row['approver6'])){
                if(file_exists("../../../../../../assets/images/Signatures/sign-".$row['approver6'].".png")){
                    $approver6sign = '<div class="img-container"><img src="assets/images/Signatures/sign-'.$row['approver6'].'.png" style="width: 70px;height: 40px;"></div>';
                }else{
                    $approver6sign = '<div class="img-container"><img src="assets/images/Signatures/default.png" style="width: 70px;height: 40px;"></div>';
                }
			}
            ...
            if(!empty($row['approver7'])){
                if(file_exists("../../../../../../assets/images/Signatures/sign-".$row['approver7'].".png")){
                    $approver7sign = '<div class="img-container"><img src="assets/images/Signatures/sign-'.$row['approver7'].'.png" style="width: 70px;height: 40px;"></div>';
                }else{
                    $approver7sign = '<div class="img-container"><img src="assets/images/Signatures/default.png" style="width: 70px;height: 40px;"></div>';
                }
            }
            ...
            $data[] = array(
                ...
                "currenttotalcashcomp"			=>	number_format(floatval($row['currentbasepay']) + getSumAllowance($con, $row['requestor']),2),
                ...
                'approver1stat'        		    =>  $row['approver1_status'],
                ...
                'approver2stat'        		    =>  $row['approver2_status'],
                ...
                'approver3stat'        		    =>  $row['approver3_status'],
                ...
                'approver4stat'        		    =>  $row['approver4_status'],
                ...
                'approver5stat'        		    =>  $row['approver5_status'],
                ...
                'approver6stat'        		    =>  $row['approver6_status'],
                ...
                'approver7stat'        		    =>  $row['approver7_status'],
            );
        }
...
// function getFullname($con, $employeeid){
//     $Qry=new Query();
//     $Qry->table="pr_account";
...
//Get Approver Account Type [Department or Designation]
// function getDesignation($con, $employeeid){
//     $Qry=new Query();
//     $Qry->table="pr_account";
//     $Qry->selected="account_type";
//     $Qry->fields="employeeid='".$employeeid."'";
//     $rs=$Qry->exe_SELECT($con);
//     if(mysqli_num_rows($rs)>=1){
//         while($row=mysqli_fetch_array($rs)){
//             //return $row['account_type'];
//             return str_replace("_", " ", $row['account_type']);
//         }
//     }
//     else{
//         $Qry=new Query();
