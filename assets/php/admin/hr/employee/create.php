															...
															if( !empty( $param['info']['civilstat'] ) ){																	
																if( (int)$param['info']['civilstat'] > 1 && empty( $param['info']['spouse'] ) ){
																	...
																	if( !empty( $param['info']['idtax'] ) ){																	
																		...
																		$Qry->selected 	= "sameaddress,isprivacy,empid,password,idaccttype,idemptype,fname,lname,mname,sex,cnumber,bdate,bplace,citizenship,religion,civilstat,idtax,date_create";
																		$Qry->fields 	= "'".(int)$param['info']['sameaddress']."',
																						   '".$param['info']['isprivacy']."',
																						   '".$param['info']['empid']."',
																						   '".md5($param['pword'])."',
																						   '".$param['info']['idaccttype']."',
																						   '".$param['info']['idemptype']."',
																						   '".$param['info']['fname']."',
																						   '".$param['info']['lname']."',
																						   '".$param['info']['mname']."',
																						   '".$param['info']['sex']."',
