											...
											if( !empty( $data['idsss'] ) ){                            
												if( !empty( $data['idibig'] ) ){                            
													if( !empty( $data['idhealth'] ) ){  
														$array_insert[]	= array(
															substr(str_replace("'","",$elt[0]),0,4),
															str_replace("'","",$elt[1]),
															str_replace("'","",$elt[2]),
															substr(str_replace("'","",$elt[3]),0,20),
															substr(str_replace("'","",$elt[4]),0,20),
															substr(str_replace("'","",$elt[5]),0,150),
															$elt[6],
															$elt[7],
															$elt[8],
															substr(str_replace("'","",$elt[9]),0,200),
															substr(str_replace("'","",$elt[10]),0,25),
															substr(str_replace("'","",$elt[11]),0,25),
															substr(str_replace("'","",$elt[12]),0,25),
															substr(str_replace("'","",$elt[13]),0,25),
															substr(str_replace("'","",$elt[14]),0,200),
															substr(str_replace("'","",$elt[15]),0,200),
															substr(str_replace("'","",$elt[16]),0,200),
															substr(str_replace("'","",$elt[17]),0,200),
															substr(str_replace("'","",$elt[18]),0,200),
															substr(str_replace("'","",$elt[19]),0,4),
															str_replace("'","",$elt[20]),
															str_replace("'","",$elt[21])
														);
														/*$Qry            = new Query();	
